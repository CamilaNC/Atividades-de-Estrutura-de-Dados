...
class Tabuleiro:
    ...
    def fazer_jogada(self, linha, coluna, jogador):
        """
        Marca a jogada na matriz se a posição estiver vazia.
    ...
    def tem_campeao(self):
        ...
        Retorna JOGADOR_0 ou JOGADOR_X se houver campeão, ou DESCONHECIDO se ainda não houver.
        """
    ...
    def __str__(self):
        """
        Representação do tabuleiro como string para debug.
        """
